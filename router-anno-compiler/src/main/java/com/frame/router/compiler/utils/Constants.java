package com.frame.router.compiler.utils;
...
public interface Constants {
    ...
    String ANNO_FACADE_PKG = "com.frame.router.facade";
    ...
    String ISYRINGE = "com.frame.component.router.ISyringe";

    String JSON_SERVICE = "com.frame.component.service.JsonService";

    String BASECOMPROUTER = "com.frame.component.router.ui.BaseCompRouter";
}
