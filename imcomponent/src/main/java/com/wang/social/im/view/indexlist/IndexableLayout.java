...
import com.wang.social.im.view.indexlist.database.DataObserver;
import com.wang.social.im.view.indexlist.database.HeaderFooterDataObserver;
import com.wang.social.im.view.indexlist.database.IndexBarDataObserver;
...
public class IndexableLayout extends FrameLayout {
    ...
    private int mBarTextColor, mBarFocusTextColor, mBarFocusBgColor;
    ...
    @IntDef({MODE_FAST, MODE_ALL_LETTERS, MODE_NONE, MODE_FIRST})
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.im_IndexableRecyclerView);
            mBarTextColor = a.getColor(R.styleable.im_IndexableRecyclerView_im_indexBar_textColor, ContextCompat.getColor(context, R.color.im_default_indexBar_textColor));
            mBarTextSize = a.getDimension(R.styleable.im_IndexableRecyclerView_im_indexBar_textSize, getResources().getDimension(R.dimen.im_default_indexBar_textSize));
            mBarFocusTextColor = a.getColor(R.styleable.im_IndexableRecyclerView_im_indexBar_selectedTextColor, ContextCompat.getColor(context, R.color.im_default_indexBar_selectedTextColor));
            mBarTextSpace = a.getDimension(R.styleable.im_IndexableRecyclerView_im_indexBar_textSpace, getResources().getDimension(R.dimen.im_default_indexBar_textSpace));
            mBarBg = a.getDrawable(R.styleable.im_IndexableRecyclerView_im_indexBar_background);
            mBarWidth = a.getDimension(R.styleable.im_IndexableRecyclerView_im_indexBar_layout_width, getResources().getDimension(R.dimen.im_default_indexBar_layout_width));
            mBarFocusBgColor = a.getColor(R.styleable.im_IndexableRecyclerView_im_indexBar_selectedBackgroundColor, ContextCompat.getColor(context, R.color.im_default_indexBar_selectedBackgroundColor));
            a.recycle();
        }
        ...
        mIndexBar.init(mBarBg, mBarTextColor, mBarFocusTextColor, mBarFocusBgColor, mBarTextSize, mBarTextSpace);
    ...
    private void stickyNewViewHolder(String wrapperTitle) {
        if ((wrapperTitle != null && !wrapperTitle.equals(mStickyTitle))) {
            ...
            mIndexableAdapter.onBindTitleViewHolder(mStickyViewHolder, wrapperTitle, true);
        }
    }
    ...
    private void initCenterOverlay() {
        ...
        mCenterOverlay.setBackgroundResource(R.drawable.im_indexable_bg_md_overlay);
            ...
            for (List<EntityWrapper<T>> indexableEntities : map.values()) {
                if (mComparator != null) {
                    ...
                    if (mCompareMode == MODE_FAST) {
                        ...
                        Collections.sort(indexableEntities, comparator);
                    } else if (mCompareMode == MODE_FIRST) {
                        comparator = new FirstPinyinComparator<T>();
                        Collections.sort(indexableEntities, comparator);
                    }
                }
