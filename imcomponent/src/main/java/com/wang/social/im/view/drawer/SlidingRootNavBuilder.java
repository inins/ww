...
import com.wang.social.im.view.drawer.callback.DragStateListener;
import com.wang.social.im.view.drawer.transform.CompositeTransformation;
import com.wang.social.im.view.drawer.transform.ElevationTransformation;
import com.wang.social.im.view.drawer.transform.RootTransformation;
import com.wang.social.im.view.drawer.transform.ScaleTransformation;
import com.wang.social.im.view.drawer.transform.YTranslationTransformation;
import com.wang.social.im.view.drawer.util.ActionBarToggleAdapter;
import com.wang.social.im.view.drawer.util.DrawerListenerAdapter;
import com.wang.social.im.view.drawer.util.HiddenMenuClickConsumer;
...
public class SlidingRootNavBuilder {
    ...
    private SlidingRootNavLayout createAndInitNewRoot(View oldRoot) {
        ...
        newRoot.setId(R.id.im_root_layout);
    ...
    private ViewGroup getContentView() {
        ...
        if (contentView.getChildCount() != 1) {
            throw new IllegalStateException(activity.getString(R.string.im_ex_bad_content_view));
        }
        return contentView;
    }
    ...
    private View getMenuViewFor(SlidingRootNavLayout parent) {
        if (menuView == null) {
            if (menuLayoutRes == 0) {
                throw new IllegalStateException(activity.getString(R.string.im_ex_no_menu_view));
            }
    ...
    protected void initToolbarMenuVisibilityToggle(final SlidingRootNavLayout sideNav, View drawer) {
        if (toolbar != null) {
            ...
            ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(activity, dlAdapter, toolbar,
                    R.string.im_drawer_open,
                    R.string.im_drawer_close);
            toggle.syncState();
