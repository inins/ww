package com.wang.social.im.view.emotion.adapter;
...
public class EmoticonsAdapter<T> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.im_emotion_item, null);
            viewHolder.rootView = convertView;
            viewHolder.ly_root = convertView.findViewById(R.id.ei_ll_root);
            viewHolder.iv_emoticon = convertView.findViewById(R.id.ei_iv_emoticon);
