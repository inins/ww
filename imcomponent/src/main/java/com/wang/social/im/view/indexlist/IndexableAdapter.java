...
import com.wang.social.im.view.indexlist.database.DataObservable;
...
public abstract class IndexableAdapter<T extends IndexableEntity> {
    ...
    public abstract void onBindTitleViewHolder(RecyclerView.ViewHolder holder, String indexTitle, boolean isSticky);
