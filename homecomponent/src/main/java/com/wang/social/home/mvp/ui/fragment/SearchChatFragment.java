...
public class SearchChatFragment extends BasicFragment implements BaseAdapter.OnItemClickListener<TestEntity>{
    ...
    private RecycleAdapterSearchChat adapter;
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        adapter = new RecycleAdapterSearchChat();
