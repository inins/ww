...
public class SearchFunshowFragment extends BasicFragment implements BaseAdapter.OnItemClickListener<TestEntity>{
    ...
    private RecycleAdapterSearchFunshow adapter;
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        adapter = new RecycleAdapterSearchFunshow();
