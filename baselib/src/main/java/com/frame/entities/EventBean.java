...
public class EventBean implements Serializable {
    ...
    // 同意加入趣聊成功
    public static final int EVENTBUS_AGREE_ADD_GROUP_SUCCESS = 0xffa142;
    // 拒绝加入趣聊成功
    public static final int EVENTBUS_REFUSE_ADD_GROUP_SUCCESS = 0xffa143;
    // 话题评论成功
    ...
    // 话题发布成功
    public static final int EVENTBUS_ADD_TOPIC_SUCCESS = 0xffa154;
    // 话题删除成功
    public static final int EVENTBUS_DEL_TOPIC_SUCCESS = 0xffa155;
    ...
    //个人中心提现
    public static final int EVENT_ACCOUNT_DEPOSIT = 0xffa209;
    //个人中心兑换宝石
    public static final int EVENT_ACCOUNT_EXCHANGE_STONE = 0xffa210;
    //个人中心充值成功
    public static final int EVENT_ACCOUNT_RECHARGE_SUCCESS = 0xffa211;
    //个人中心收支明细切换筛选条件
    public static final int EVENT_DEPOSITDETAIL_SORT = 0xffa212;
    ...
    //游戏房间输入框Emoji隐藏
    public static final int EVENT_GAME_INPUT_EMOJI_GONE = 0xffa604;
    ...
    @IntDef({
            ...
            EVENTBUS_AGREE_ADD_GROUP_SUCCESS,
            EVENTBUS_REFUSE_ADD_GROUP_SUCCESS,
            EVENTBUS_ADD_TOPIC_COMMENT,
            EVENTBUS_ADD_TOPIC_SHARE,
            EVENTBUS_TOPIC_SUPPORT,
            EVENTBUS_TOPIC_COMMENT_SUPPORT,
            EVENTBUS_ADD_TOPIC_SUCCESS,
            EVENTBUS_DEL_TOPIC_SUCCESS,
