...
public final class ToastUtil {
    ...
    public static void showToastLong(String msg) {
        showToast(Utils.getContext(), msg, Toast.LENGTH_LONG, false);
    }

    @SuppressWarnings("WeakerAccess")
    public static void showToastShort(String msg) {
        showToast(Utils.getContext(), msg, Toast.LENGTH_SHORT, false);
    }
    ...
    public static void showToastShort(String msg, boolean needStyle) {
        showToast(Utils.getContext(), msg, Toast.LENGTH_SHORT, needStyle);
    }
