...
public class FixWidthListView extends ListView {
    public FixWidthListView(Context context) {
        super(context);
    }

    public FixWidthListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FixWidthListView(Context context, AttributeSet attrs, int defStyleAttr) {
