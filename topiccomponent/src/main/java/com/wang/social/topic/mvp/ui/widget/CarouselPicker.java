        ...
        if (attrs != null) {
            ...
            switch (itemsVisible) {
                case 3:
                    ...
                    getResources().getValue(R.dimen.topic_three_items, threeValue, true);
                    divisor = threeValue.getFloat();
                    break;
                case 5:
                    TypedValue fiveValue = new TypedValue();
                    getResources().getValue(R.dimen.topic_five_items, fiveValue, true);
                    divisor = fiveValue.getFloat();
                    break;
                case 7:
                    TypedValue sevenValue = new TypedValue();
                    getResources().getValue(R.dimen.topic_seven_items, sevenValue, true);
