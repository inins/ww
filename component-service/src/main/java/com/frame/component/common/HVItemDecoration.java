...
public class HVItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public HVItemDecoration(Context context, @Orientation int orientation) {
    ...
    public void drawVerticalDividers(Canvas c, RecyclerView parent) {
        final int left = parent.getPaddingLeft() + leftMarginSize;
        final int right = parent.getWidth() - parent.getPaddingRight() - rightMarginSize;
