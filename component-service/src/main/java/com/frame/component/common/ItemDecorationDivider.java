...
public class ItemDecorationDivider extends RecyclerView.ItemDecoration {
    ...
    public ItemDecorationDivider setLineMargin(int lineMargin) {
        this.lineMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, lineMargin, Resources.getSystem().getDisplayMetrics());
        return this;
    }
...
//        Log.v("recyclerview - itemdecoration", "onDraw()");
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        final int left = parent.getPaddingLeft() + lineMargin;
        final int right = parent.getWidth() - parent.getPaddingRight() - lineMargin;
