...
public class ToolbarTansColorHelper {

    private static ToolbarTansColorHelper INSTANCE;

    private ToolbarTansColorHelper() {
        //默认值
        this.colorStart = Color.parseColor("#002f76b8");
        this.colorEnd = Color.parseColor("#2f76b8");
        this.heightMax = SizeUtils.dp2px(200);
    }
    ...
    public static ToolbarTansColorHelper with(Toolbar toolbar) {
        if (INSTANCE == null) INSTANCE = new ToolbarTansColorHelper();
        INSTANCE.toolbar = toolbar;
        INSTANCE.context = toolbar.getContext();
        return INSTANCE;
    }

    public ToolbarTansColorHelper initColorStart(int colorStart) {
        this.colorStart = colorStart;
        return this;
    }

    public ToolbarTansColorHelper initColorEnd(int colorEnd) {
        this.colorEnd = colorEnd;
        return this;
    }

    public ToolbarTansColorHelper initMaxHeight(int heightMax) {
        this.heightMax = heightMax;
        return this;
    }

    public ToolbarTansColorHelper onPointCallback(OnPointListener onPointListener) {
