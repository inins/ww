...
public class WheelPicker<T> extends View {
    ...
    /**
     * 是否显示幕布的水平边框(和上面的属性独立)
     */
    private boolean mIsShowCurtainBorderHorizontal;
...
//				}
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        mIsShowCurtainBorderHorizontal = a.getBoolean(R.styleable.WheelPicker_wheelCurtainBorder, false);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIsShowCurtainBorderHorizontal) {
            mPaint.setStyle(Paint.Style.STROKE);
            mPaint.setColor(mCurtainBorderColor);
    ...
    public void setShowCurtainBorderHorizontal(boolean showCurtainBorderHorizontal) {
        if (mIsShowCurtainBorderHorizontal == showCurtainBorderHorizontal) {
            return;
        }
        mIsShowCurtainBorderHorizontal = showCurtainBorderHorizontal;
        postInvalidate();
    }
