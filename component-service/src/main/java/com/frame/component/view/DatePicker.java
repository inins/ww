...
public class DatePicker extends LinearLayout implements YearPicker.OnYearSelectedListener,
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        boolean isShowCurtainBorderHorizontal = a.getBoolean(R.styleable.DatePicker_wheelCurtainBorderHorizontal, true);
        ...
        setShowCurtainBorderHorizontal(isShowCurtainBorderHorizontal);
    ...
    /**
     * @param showCurtainBorderHorizontal
     */
    public void setShowCurtainBorderHorizontal(boolean showCurtainBorderHorizontal) {
        mDayPicker.setShowCurtainBorderHorizontal(showCurtainBorderHorizontal);
        mMonthPicker.setShowCurtainBorderHorizontal(showCurtainBorderHorizontal);
        mYearPicker.setShowCurtainBorderHorizontal(showCurtainBorderHorizontal);
    }
