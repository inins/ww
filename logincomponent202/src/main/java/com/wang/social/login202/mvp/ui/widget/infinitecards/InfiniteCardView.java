...
/**
 * @author BakerJ
 *         https://github.com.wang.social.login202.mvp.ui.widgetQ/InfiniteCards
 */
public class InfiniteCardView extends ViewGroup {
    public static final String TAG = InfiniteCardView.class.getSimpleName().toString();
    /*
    ...
    private static final float CARD_SIZE_RATIO = 1.0f;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.login202_InfiniteCardView);
            animType = ta.getInt(R.styleable.login202_InfiniteCardView_login202_animType, ANIM_TYPE_FRONT);
            mCardRatio = ta.getFloat(R.styleable.login202_InfiniteCardView_login202_cardRatio, CARD_SIZE_RATIO);
            animDuration = ta.getInt(R.styleable.login202_InfiniteCardView_login202_animDuration, CardAnimationHelper.ANIM_DURATION);
            animAddRemoveDuration = ta.getInt(R.styleable.login202_InfiniteCardView_login202_animAddRemoveDuration,
                    CardAnimationHelper.ANIM_ADD_REMOVE_DURATION);
            animAddRemoveDelay = ta.getInt(R.styleable.login202_InfiniteCardView_login202_animAddRemoveDelay,
...
//        Log.i(TAG, "onLayout");
    ...
    public LinkedList<CardItem> getCards() {
        return mAnimationHelper.getCards();
    }
