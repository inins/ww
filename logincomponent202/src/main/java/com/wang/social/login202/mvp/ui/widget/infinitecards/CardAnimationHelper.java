...
import com.wang.social.login202.mvp.ui.widget.infinitecards.transformer.DefaultTransformerAdd;
import com.wang.social.login202.mvp.ui.widget.infinitecards.transformer.DefaultTransformerRemove;
import com.wang.social.login202.mvp.ui.widget.infinitecards.transformer.DefaultTransformerToBack;
import com.wang.social.login202.mvp.ui.widget.infinitecards.transformer.DefaultTransformerToFront;
import com.wang.social.login202.mvp.ui.widget.infinitecards.transformer.DefaultZIndexTransformerCommon;
import com.wang.social.login202.mvp.ui.widget.infinitecards.transformer.DefaultZIndexTransformerToFront;
...
class CardAnimationHelper implements Animator.AnimatorListener,
    ...
    public static final String TAG = CardAnimationHelper.class.getSimpleName().toString();
...
//        Log.i(TAG, "doAnimationBackToFront : " + fraction + " " + fractionInterpolated);
...
//        Log.i(TAG, "doAnimationFrontToBack : " + fraction + " " + fractionInterpolated);
...
//        Log.i(TAG, "doAnimationCommon : " + fraction + " " + fractionInterpolated);
        if (mAnimType == InfiniteCardView.ANIM_TYPE_FRONT) {
